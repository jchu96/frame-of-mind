...
Hosted recording upload is implemented but remains dark and undeployed as of
2026-08-23. Accepted ADR 0018 Amendment 2 uses a short-lived browser-to-Gemini
...
one tab's session draft. Private R2 retained media and evidence capture are
implemented in the dark artifact with a visible lifecycle; no bucket or
deployment has been created. See the
